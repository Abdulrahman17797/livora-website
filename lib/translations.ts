...
const ar: SiteTranslation = {
  ...
  home: {
    heroBadge: "كومبوتشا صناعة صغيرة",
    heroH1: ["اشرب وأحسّ", "بالحياة"],
    heroSub:
      "يُصنع Livora كومبوتشا من مكونات طبيعية وثقافات حية، مع الإيمان بأن ما تشربه يجب أن يجعلك تشعر بشيء استثنائي.",
    heroPrimary: "اطلب الآن",
    heroSecondary: "قصتنا",
    liveBadge: "مخمّر طازج عند الطلب — 3 نكهات متاحة الآن",
    flavoursH2: ["", "نكهاتنا"],
    flavoursSub: "ثلاث نكهات كومبوتشا تُخمَّر طازجة عند الطلب في البحرين.",
    viewDetails: "التفاصيل ←",
    brewH2: ["مخمّر", "بهدف"],
    brewBody:
      "نستخدم شاياً عضوياً وسكر قصب خاماً، ونترك الوقت يكمل عمله. بلا اختصارات. بلا مضافات اصطناعية. فقط كومبوتشا نقي وحي يشكرك معدتك عليه.",
    stats: [
      { stat: "5–7", label: "أيام تخمير عند الطلب" },
      { stat: "100%", label: "شاي عضوي" },
      { stat: "0g", label: "سكر اصطناعي" },
    ],
    ctaH2: ["هل أنت مستعد", "لتشعر بالفرق؟"],
    ctaSub: "اطلب كومبوتشاك وسنخمّره طازجاً لك.",
    ctaBtn: "ابدأ طلبك",
  },
  products: {
    badge: "المجموعة",
    h1: ["", "كومبوتشاتنا"],
    sub: "ثلاث نكهات. تُخمَّر طازجة عند الطلب في البحرين. بلا أي مواد اصطناعية.",
    orderNow: "اطلب الآن",
    brewNote:
      "متوفر بحجمي 500 مل و 1 لتر | صناعة يدوية في البحرين. بلا مواد حافظة. بلا اختصارات. خام. حي. لذيذ. يُخمَّر طازجاً عند الطلب — يُرجى السماح بـ 5–7 أيام للتحضير قبل التوصيل.",
    ctaH2: ["هل أنت مستعد", "لتذوق الفرق؟"],
    ctaSub: "ضع طلبك وسنخمّره طازجاً. التوصيل خلال 5–7 أيام.",
    ctaBtn: "اطلب الآن",
  },
  about: {
    badge: "قصتنا",
    h1: ["نخمّر من أجل", "من يهتم"],
    valuesH2: ["ما نؤمن", "به"],
    ...
    values: [
      ...
      {
        title: "بلا اختصارات",
        body: "كل دفعة تُخمَّر طازجة عند الطلب في 5–7 أيام. بلا بسترة، بلا اختصارات — فقط كومبوتشا صادق يُعبَّأ في أوج نضجه.",
        emoji: "⏳",
      },
      {
  ...
  order: {
    badge: "ضع طلبك",
    h1: ["ضع", "طلبك"],
    sub: "اختر نكهاتك، أدخل بياناتك، وسنخمّره طازجاً لك.",
    ...
    total: "المجموع",
    brewNote:
      "يُخمَّر طازجاً عند الطلب — يُرجى السماح بـ 5–7 أيام للتحضير قبل التوصيل.",
