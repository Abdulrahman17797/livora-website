      ...
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-start justify-between gap-10">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="https://wa.me/97338388211"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-gray-500 hover:text-[#9B5DE5] transition-colors"
              >
            ...
            <li>
              <a
                href="https://instagram.com/livora.bahrain"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm text-gray-500 hover:text-[#9B5DE5] transition-colors"
              >
